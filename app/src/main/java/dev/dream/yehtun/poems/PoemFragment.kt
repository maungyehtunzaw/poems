...
class PoemFragment : Fragment() {
    ...
    private var mListener: PoetFragment.OnFragmentInteractionListener? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        if (arguments != null) {
            mParam1 = arguments.getString(PoetFragment.ARG_PARAM1)
            mParam2 = arguments.getString(PoetFragment.ARG_PARAM2)
        }
    }
